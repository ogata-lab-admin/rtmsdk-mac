...
# @author Noriaki Ando
# @date 2013年 8月19日 月曜日 22時03分25秒 JST
#
...
set(OPENRTM_INCLUDE_DIRS /opt/universal/x86_64/include /opt/universal/x86_64/include/coil-1.1 /opt/universal/x86_64/include/openrtm-1.1 /opt/universal/x86_64/include/openrtm-1.1/rtm/idl)
set(OPENRTM_LDFLAGS  --export-dynamic )
set(OPENRTM_LIBRARY_DIRS /opt/universal/x86_64/lib)
set(OPENRTM_LIBRARIES omniORB4 omnithread omniDynamic4 RTC coil)
set(OPENRTM_LIB_DIR /opt/universal/x86_64/lib/openrtm-1.1)
set(OPENRTM_DIR /opt/universal/x86_64)

# OpenRTM-aist specific directory
set(COIL_INCLUDE_DIR /opt/universal/x86_64/include/coil-1.1)
set(OPENRTM_INCLUDE_DIR /opt/universal/x86_64/include/openrtm-1.1)
set(OPENRTM_LIB_DIR /opt/universal/x86_64/lib/openrtm-1.1)
set(OPENRTM_DATA_DIR /opt/universal/x86_64/share/openrtm-1.1)
